...
const PrivacyPolicy: NextPage = () => (
  <>
    ...
    <div className="container py-8 space-y-4">
      ...
      <p>
        At TX Labs, accessible from www.txlabs.org, one of our main priorities
        is the privacy of our visitors. This Privacy Policy document contains
        types of information that is collected and recorded by TX Labs and how
        we use it.
      </p>
      <p>
        If you have additional questions or require more information about our
        Privacy Policy, do not hesitate to contact us via{' '}
        <a href="mailto:hi@txlabs.org">hi@txlabs.org</a>
      </p>
      <p>
        This Privacy Policy applies only to our online activities and is valid
        for visitors to our website with regards to the information that they
        shared and/or collect in TX Labs. This policy is not applicable to any
      ...
      <h2>Log Files</h2>
      <p>
        TX Labs follows a standard procedure of using log files. These files log
      ...
      <p>
        Like any other website, TX Labs uses &apos;cookies&apos;. These cookies
      ...
      <p>
        ...
        advertising partners of TX Labs.
      </p>
      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on TX Labs, which are sent directly
      ...
      <p>
        Note that TX Labs has no access to or control over these cookies that
        are used by third-party advertisers.
      </p>
      <h2>Third Party Privacy Policies</h2>
      <p>
        TX Labs&apos;s Privacy Policy does not apply to other advertisers or
      ...
      <p>
        TX Labs does not knowingly collect any Personal Identifiable Information
